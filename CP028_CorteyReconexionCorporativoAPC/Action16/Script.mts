...
DataTable("s_Resultado","RecoAPC") ="Fallido"
DataTable("s_Detalle","RecoAPC") ="Error al consultar servicio web"
Reporter.ReportEvent micFail, DataTable("s_Resultado","RecoAPC"), DataTable("s_Detalle","RecoAPC")
